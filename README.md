...
##Get Started
**(1)** You can install ng-storage using 3 different ways:<br/>
**Git:**
clone & build [this](https://github.com/andreschait/ng-storage.git) repository<br/>
**Bower:**
```bash
$ bower install ng-storage --save
```
**npm:**
```bash
$ npm install ng-storage
```
**(2)** Include `ng-storage.js` (or `ng-storage.min.js`) from the [dist](https://github.com/andreschait/ng-storage/tree/master/dist) directory in your `index.html`, after including Angular itself.
...
<body>
    ...
    <script src="bower_components/js/ng-storage.min.js"></script>
    ...
    <script>
...
Clone the project:
```sh
$ git clone https://github.com/<your-repo>/ng-storage.git
$ npm install
$ bower install
```
Run the tests:
...
[npm-image]: https://img.shields.io/npm/v/ng-storage.svg?style=flat-square
[npm-url]: https://npmjs.org/package/ng-storage
[travis-image]: https://img.shields.io/travis/andreschait/ng-storage.svg?style=flat-square
[travis-url]: https://travis-ci.org/andreschait/ng-storage
[coveralls-image]: https://img.shields.io/coveralls/andreschait/ng-storage.svg?style=flat-square
[coveralls-url]: https://coveralls.io/r/andreschait/ng-storage
[david-image]: http://img.shields.io/david/andreschait/ng-storage.svg?style=flat-square
[david-url]: https://david-dm.org/andreschait/ng-storage
[license-image]: http://img.shields.io/npm/l/ng-storage.svg?style=flat-square
[license-url]: LICENSE
[downloads-image]: http://img.shields.io/npm/dm/ng-storage.svg?style=flat-square
[downloads-url]: https://npmjs.org/package/ng-storage
[gitter-image]: https://badges.gitter.im/Join%20Chat.svg
[gitter-url]: https://gitter.im/andreschait/ng-storage?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
